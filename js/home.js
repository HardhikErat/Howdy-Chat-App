...
if(currentuser.id !== alluser.id){
  ...
  let videoBtn = document.createElement(`input`)
  videoBtn.setAttribute(`type`, `button`)
  videoBtn.setAttribute(`value`, `Video Call`)
  videoBtn.setAttribute(`id`, alluser.id)
  videoBtn.setAttribute(`class`, `btn btn-primary`)
  videoBtn.style = `float: right; margin-top: 15px; margin-right: 20px`
  ...
  let audioBtn = document.createElement(`input`)
  audioBtn.setAttribute(`type`, `button`)
  audioBtn.setAttribute(`value`, `Audio Call`)
  audioBtn.setAttribute(`id`, alluser.id)
  audioBtn.setAttribute(`class`, `btn btn-primary`)
 audioBtn.style = `float: right; margin-top: 15px; margin-right: 20px`
